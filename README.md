This is a memory game created with React. It has a fall theme! The application's UI is broken into components, component state is managed and there are responses to user events. 
